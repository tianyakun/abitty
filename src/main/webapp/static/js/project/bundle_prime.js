...
$Prime = window.$Prime || {};
$Prime.render = function(tpl, data){
    var tempFn = doT.template(tpl);
    return tempFn(data);
}
$Prime.SPAWrapper = function(id){
    return $("#"+id);
}

$Prime.getUrlParam = function(name){
...
var __WEBPACK_AMD_DEFINE_RESULT__;/* Zepto v1.2.0-10-g97de412 - zepto ajax callbacks data deferred detect form selector event touch - zeptojs.com/license */
