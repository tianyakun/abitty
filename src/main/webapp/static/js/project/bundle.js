...
module.exports = "<section class=product-select-wrapper> <div class=page-service-form> <form id=J_form method=POST class=\"page-item-form book-wrapper\"> <ul> <li class=item-cells> <div class=item-cell> <div class=item-cell-hd> <label for=\"\" class=cell-label>订几个月？</label> </div> <div class=item-cell-bd> <select name=\"\" class=ui-select id=J_time> {{? it.deliveryType == \"weekly\"}} <option value=1|4>1月(4次)</option> <option value=3|12>3月(12次)</option> <option value=6|24>6月(24次)</option> {{?? it.deliveryType == \"monthly\"}} <option value=1|1>1月(1次)</option> <option value=3|3>3月(3次)</option> <option value=6|6>6月(6次)</option> {{?}} </select> </div> </div> </li> <li class=item-cells> <div class=item-cell> <div class=item-cell-hd> <label class=cell-label>每次送几件？</label> </div> <div class=item-cell-bd> <select name=\"\" class=ui-select id=J_count> <option value=1>1件</option> <option value=2>2件</option> <option value=3>3件</option> </select> </div> </div> </li> <li class=\"item-cells last-child-sub-wrapper\"> <div class=item-cell> <div class=item-cell-hd> <label class=cell-label>备注：</label> </div> <div class=item-cell-bd> <textarea name=remark id=\"\" cols=30 rows=10></textarea> </div> </div> </li> <li class=\"item-cells last-child-sub-wrapper\"> <div class=item-cell> <div class=item-cell-hd> <label class=cell-label>总价：</label> </div> <div class=item-cell-bd> <p class=total-price><span id=J_total>0</span>元</p> <input type=hidden name=subQuantity> <input type=hidden name=totalSub> <input type=hidden name=totalAmount> <input type=hidden name=totalQuantity> <input type=hidden name=totalMouth> <input type=hidden name=serviceAtomCount> </div> </div> </li> </ul> </form> </div> </section> <a href=\"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx6567f481349fba16&redirect_uri=http://www.abitty.com/view/book&response_type=code&scope=snsapi_base&state=STATE#wechat_redirect;\" id=J_select class=foot-fixed-btn>确定</a> ";
...
module.exports = "<section class=bottom-tab> <a href=/view/myService> <i class=tab-service-icon></i> <p>已订购</p> </a> <a href=/view/supports> <i class=tab-supports-icon></i> <p>商城</p> </a> <a href=/view/user> <i class=tab-user-icon></i> <p>我的</p> </a> </section>";
...
module.exports = "<section class=start-service> <h1 class=logo></h1> <form id=J_login_form action=\"\" method=POST onsubmit=return!1 class=login-form> <ul> <li class=item-cells> <div class=item-cell> <div class=item-cell-hd> <label class=cell-label>手机号：</label> </div> <div class=item-cell-bd> <input type=tel name=phone maxlength=11 placeholder=请输入手机号 class=ui-input> </div> </div> </li> <li class=item-cells> <div class=item-cell> <div class=item-cell-hd> <label class=cell-label>验证码：</label> </div> <div class=item-cell-bd> <input type=number name=vcode placeholder=请输入验证码 class=ui-input> </div> <div class=\"item-cell-ft v-code-wrapper\"><a id=J_code class=vcode>发送验证码</a></div> </div> </li> <li class=\"item-cells agreement-cells\"> <div class=item-cell> <div class=item-cell-hd> <input name=agreement type=checkbox checked=checked> </div> <div class=item-cell-bd> <label>我已同意《一点生活服务协议》</label> </div> </div> </li> <li> <button class=sb-btn>登录</button> </li> </ul> </form> </section>";

/***/ }),
/* 41 */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),
/* 42 */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),
/* 43 */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"
