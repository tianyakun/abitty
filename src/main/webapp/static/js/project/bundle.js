...
module.exports = "<section class=bottom-tab> <a href=/view/myService> <i class=tab-service-icon></i> <p>已订</p> </a> <a href=/view/supports> <i class=tab-supports-icon></i> <p>分类</p> </a> <a href=/view/user> <i class=tab-user-icon></i> <p>已订</p> </a> </section>";
