...
module.exports = "<section class=\"user-info page-list\"> <ul> <li class=item-cells> <a href=/view/user/person> <div class=item-cell> <div class=item-cell-bd> <p class=\"text-label icon-user-info\">个人信息</p> <i class=icon-next></i> </div> </div> </a> </li> </ul> <div class=loginout-wrapper> <form action=/logout method=get> <button class=btn2 style=\"background:0 0\">退出</button> </form> </div> </section>";
