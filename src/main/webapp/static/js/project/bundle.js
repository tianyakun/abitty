...
module.exports = "<section class=product-select-wrapper> <div class=page-service-form> <form id=J_form method=POST class=\"page-item-form book-wrapper\"> <ul> <li class=item-cells> <div class=item-cell> <div class=item-cell-hd> <label for=\"\" class=cell-label>订几个月？</label> </div> <div class=\"item-cell-bd book-select\"> <select name=\"\" class=ui-select id=J_time> {{? it.deliveryType == \"weekly\"}} <option value=1|4>1月(4次)</option> <option value=3|12>3月(12次)</option> <option value=6|24>6月(24次)</option> {{?? it.deliveryType == \"monthly\"}} <option value=1|1>1月(1次)</option> <option value=3|3>3月(3次)</option> <option value=6|6>6月(6次)</option> {{?}} </select> <i class=icon-next></i> </div> </div> </li> <li class=item-cells> <div class=item-cell> <div class=item-cell-hd> <label class=cell-label>每次送几件？</label> </div> <div class=\"item-cell-bd book-select\"> <select name=\"\" class=ui-select id=J_count> <option value=1>1件</option> <option value=2>2件</option> <option value=3>3件</option> </select> <i class=icon-next></i> </div> </div> </li> <li class=\"item-cells last-child-sub-wrapper\"> <div class=item-cell> <div class=item-cell-hd> <label class=cell-label>备注：</label> </div> <div class=item-cell-bd> <textarea name=remark id=\"\" cols=30 rows=10></textarea> </div> </div> </li> <li class=\"item-cells last-child-sub-wrapper\"> <div class=item-cell> <div class=item-cell-hd> <label class=cell-label>总价：</label> </div> <div class=item-cell-bd> <p class=total-price>￥<span id=J_total>0</span></p> <input type=hidden name=subQuantity> <input type=hidden name=totalSub> <input type=hidden name=totalAmount> <input type=hidden name=totalQuantity> <input type=hidden name=totalMouth> <input type=hidden name=serviceAtomCount> </div> </div> </li> </ul> </form> </div> </section> <a href=\"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx6567f481349fba16&redirect_uri=http://www.abitty.com/view/book&response_type=code&scope=snsapi_base&state=STATE#wechat_redirect;\" id=J_select class=foot-fixed-btn>确定</a> ";
